function compare() {
    ...
    var inputAvailable = document.getElementById("input-available");
...
function addRow(counter, current, finding) {
    var resultTable = document.getElementById("resultTableBody");
    var row = resultTable.insertRow(counter);
...
function lastUnderscorePosition(inputString) {
